      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{ backgroundColor: "#111620", borderRadius: 16, padding: 24, border: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div>
              <p style={{ fontSize: 14, color: "#d1d5dc", marginBottom: 4 }}>Total Balance</p>
              <h2 style={{ fontSize: 30, fontWeight: 700, color: "#ffffff", margin: 0 }}>${balance.toFixed(2)}</h2>
              <p style={{ fontSize: 14, color: "#9ca3af", marginTop: 4 }}>≈ ${balance.toFixed(2)}</p>
            </div>
            <Link
        ...
        {/* Tabs */}
        <div style={{ display: "flex", gap: 4, backgroundColor: "#111620", borderRadius: 12, padding: 4, border: "1px solid rgba(255,255,255,0.05)", width: "fit-content" }}>
        ...
        <div style={{ backgroundColor: "#111620", borderRadius: 16, border: "1px solid rgba(255,255,255,0.05)", overflow: "hidden" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr auto auto", gap: 16, padding: "12px 24px", borderBottom: "1px solid rgba(255,255,255,0.05)", fontSize: 12, color: "#d1d5dc", textTransform: "uppercase", letterSpacing: "0.05em", fontWeight: 500 }}>
            ...
            <span style={{ textAlign: "right", width: 140 }}>24h chg%</span>
          </div>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  {coin.image ? (
                    ...
                    <div style={{ width: 32, height: 32, borderRadius: "50%", backgroundColor: "rgba(255,222,2,0.2)", display: "flex", alignItems: "center", justifyContent: "center", color: GOLD, fontSize: 12, fontWeight: 700 }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: "#9ca3af", fontSize: 12, margin: 0 }}>{coin.name} /TetherUS</p>
                  </div>
                </div>

                <span style={{ color: "#ffffff", fontWeight: 500, fontSize: 14, fontVariantNumeric: "tabular-nums" }}>
